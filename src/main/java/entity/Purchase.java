...
public class Purchase {
    ...
    public Purchase(int memberId, String username, String passwd, String address, String tel, String role, int purchaseId, int p_memberId, String title, int price, int quantity) {
        this.memberId = memberId;
        this.username = username;
        this.passwd = passwd;
        this.address = address;
